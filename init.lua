...
t[5] = "Для обсуждения игровых (и не только) вопросов советую наш телеграм канал https://t.me/MinetestServerRu. Задавайте свои вопросы администрации и другим игрокам (надеюсь они смогут ответить)."
...
t[10] = "Едой на первое время могут стать плоды на деревьях и земле, а также автомат по выдаче бесплатных печеных картофелин рядом со спавном (спасибо Karabas-у)."
t[11] = "На сервере присутствует денежная система, играя - ты зарабатываешь виртуальную валюту (банкноты). Их можно тратить с пользой в магазинах пользователей (можешь открыть свой, за рекламой обращайся к администрации)."
t[12] = "У нас тут можно заниматься садоводством, для этого есть всё - много растений, удобрения и фермы!"
t[13] = "Советую заглянуть на садоводческую ферму Arid-а возле спавна, там много чего есть, ассортимент стоящий, а цены - низкие!"
t[14] = "Накопил много семян, нужно быстро получить урожай? Воспользуйся общественной фермой у спавна (большое поле, освещение, мельница для хлеба рядом)! Либо посади и оставь урожай для других, они скажут тебе спасибо."
...
t[16] = "Играть тут могут все, кто угодно и из любой страны, сам сервер и его администрация в России, русский и английский язык для общения приветствуются. Давайте всегда уважать друг друга."
t[17] = "Нужно много древесины? Ужас, сколько деревьев наросло, не пройти! Используй автоматическую рубку, зажав клавишу 'красться'!"
t[18] = "Не забывай защищать свои постройки и несметные богатства, используй всевозможную защиту (введи protect в поиске предметов, посмотри что там есть для этого)."
...
t[22] = "Активных игроков сервера, которые чем-то полезны для других игроков и самого сервера мы очень ценим, поощряем и выделяем (да хоть личным префиксом к имени). Попробуй и ты стать таким."
t[23] = "Мы строим всё силами обычных игроков, без дополнительных прав по модификации мира и креатив режима. Да что говорить, тут даже админ - обычный игрок."
t[24] = "Я устал, немного помолчу..."
t[25] = "На сервере присутствует неколько классов пользователей: Admin, Moderator, SpawnMasson, Guru. Вот стоит немного проявить себя и можно стать кем-то из них, или заслужить новый отдельный класс (Админ тут пока добрый и щедрый)."
t[26] = "Admin на сервере один, с ником Reload, но тут редко под ним, в основном шифруется обычным пользователем с ником Test (наверное ему лень выполнять свои админские обязанности... не иначе)"
t[27] = "Наши модераторы - cubonist и Preservoir. Строги, как никогда, их цель - поддерживать порядок путем наказания провинившихся, могут выкинуть, а могут и забанить (очень это любят). Осторожно, не вступайте в конфликт с ними, я предупредил."
t[28] = "Класс SpawnMasson непросто так, от нечего делать, игроки этого класса развивают наш спавн и поддерживают его в порядке. Очень часто помогают новичкам обжиться и разобраться что к чему."
t[29] = "Всем хочется преуспеть на техническом сервере, вроде нашего, и стать Guru, но пока это покорилось лишь одному игроку, Karabas. Так что молитесь на него и стремитесь к такому же статусу на нашем сервере, ну и кушайте его запеченые картошечки у спавна (вдруг это поможет:))"
